...
void arts_main_edt(uint32_t paramc, const uint64_t *paramv, uint32_t depc,
  ...
  for (uint32_t i = 0; i < 4; i++) {
    ...
    arts_record_dep(db2, reader, 0, ARTS_MODE_RO);
  }

...
///
/// Config: ownership protocols (MRNEW/MRSW) serialize RW so the reentrant
/// branch is live.  Under LOCK RW is also serialized (alias dedup applies).
/// Under MRMW RW is NOT serialized — the reentrant branch is a no-op but the

 ...
 * pull the coherence type header (ARTS_PROTOCOL_MRNEW selected — the graph code
...
#ifndef ARTS_PROTOCOL_MRNEW
#define ARTS_PROTOCOL_MRNEW 1
#endif
...
#include "arts/coherence/types.h" /* complete struct arts_db_s (MRNEW layout) */

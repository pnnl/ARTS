...
#define ARTS_STREAM(format, ...)                                                \
  arts_atomic_print("[%u:%u] " format, arts_global_rank_id, arts_thread_info.group_id, \
                  ##__VA_ARGS__)

/// ARTS print stream accessor
#define ARTS_PRINT_STREAM(format, ...)                                           \
  arts_atomic_print("[%u:%u] " format, arts_global_rank_id, arts_thread_info.group_id, \
                  ##__VA_ARGS__)

/// ARTS formatted print stream with rank
#define ARTS_PRINT_FORMATTED(format, ...)                                      \
  arts_atomic_print("[%u:%u] " format "\n", arts_global_rank_id,                    \
                  arts_thread_info.group_id, ##__VA_ARGS__)
...
#define ARTS_DEBUG(format, ...)                                                \
  arts_atomic_print("[%u:%u] [DEBUG] " format "\n", arts_global_rank_id,            \
                  arts_thread_info.group_id, ##__VA_ARGS__)
...
#define ARTS_INFO(format, ...)                                                 \
  arts_atomic_print("[%u:%u] [INFO] " format "\n", arts_global_rank_id,             \
                  arts_thread_info.group_id, ##__VA_ARGS__)
...
#define ARTS_WARN(format, ...)                                                 \
  arts_atomic_print("[%u:%u] [WARN] " format "\n", arts_global_rank_id,             \
                  arts_thread_info.group_id, ##__VA_ARGS__)
#define ARTS_ERROR(format, ...)                                                \
  arts_atomic_print("[%u:%u] [ERROR] " format "\n", arts_global_rank_id,            \
                  arts_thread_info.group_id, ##__VA_ARGS__)

 ...
 *
 * LOCK protocol pure state-transition arbiters (EAGER timing only).
 *
 ...
 * The whitebox unit test (tests/unit/lock_compute_next.c) also #includes
...
/* ===== cache_compute_next ==============================================
 * Cache-side analogue of lock_compute_next: pure function of the current

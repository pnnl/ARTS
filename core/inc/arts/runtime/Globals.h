...
#ifdef USE_CXL
  artsCXLDeque *cxlDeque;
  pthread_mutex_t cxlLocalLock;
  void *cxlDbArenaStartPtr;
  void *cxlDbArenaEndPtr;
#endif /* USE_CXL */
...
#ifdef USE_CXL
extern volatile uint64_t createdEdts;
extern volatile uint64_t destroyedEdts;
#endif /* USE_CXL */
...
#ifdef USE_CXL
#define incCreatedEdts(numEdts) artsAtomicFetchAddU64(&createdEdts, numEdts)
#define incDestroyedEdts(numEdts) artsAtomicFetchAddU64(&destroyedEdts, numEdts)
#endif /* USE_CXL */
// #else
// #define incOustandingEdts(numEdts)
// #define decOustandingEdts(numEdts)

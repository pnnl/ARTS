...
typedef struct arts_performance_unit arts_performance_unit;

typedef struct {
  unsigned int startPoint;
  uint64_t startTimeStamp;
  uint64_t endTimeStamp;
  arts_performance_unit *coreMetric;
  arts_performance_unit *nodeMetric;
  arts_performance_unit *systemMetric;
} arts_inspector_t;

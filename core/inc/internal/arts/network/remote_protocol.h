...
// Header
struct __attribute__((__packed__)) arts_remote_packet {
...
struct __attribute__((__packed__)) arts_remote_guid_only_packet {
  struct arts_remote_packet header;
  arts_guid_t guid;
};

struct __attribute__((__packed__)) arts_remote_add_dependence_packet {
  struct arts_remote_packet header;
  arts_guid_t source;
...
struct __attribute__((__packed__)) arts_remote_add_dependence_with_byte_offset_packet {
  struct arts_remote_packet header;
  arts_guid_t source;
  arts_guid_t destination;
  uint32_t slot;
...
struct __attribute__((__packed__)) arts_remote_edt_signal_packet {
  struct arts_remote_packet header;
  arts_guid_t edt;
  arts_guid_t db;
  uint32_t slot;
...
struct __attribute__((__packed__)) arts_remote_event_satisfy_slot_packet {
  struct arts_remote_packet header;
  arts_guid_t event;
  arts_guid_t db;
  uint32_t slot;
...
struct __attribute__((__packed__)) arts_remote_persistent_event_satisfy_slot_packet {
  struct arts_remote_packet header;
  arts_guid_t event;
  uint32_t action;
  bool lock;
...
struct __attribute__((__packed__)) arts_remote_db_add_dependence_packet {
  struct arts_remote_packet header;
  arts_guid_t db_src;
...
struct __attribute__((__packed__)) arts_remote_db_add_dependence_with_byte_offset_packet {
  struct arts_remote_packet header;
  arts_guid_t db_src;
  arts_guid_t edt_dest;
  uint32_t edt_slot;
...
struct __attribute__((__packed__)) arts_remote_db_request_packet {
  struct arts_remote_packet header;
  arts_guid_t db_guid;
  arts_type_t mode;
  arts_type_t acquire_mode;
...
struct __attribute__((__packed__)) arts_remote_db_send_packet {
  struct arts_remote_packet header;
};

struct __attribute__((__packed__)) arts_remote_db_full_request_packet {
  struct arts_remote_packet header;
  arts_guid_t db_guid;
...
struct __attribute__((__packed__)) arts_remote_db_full_send_packet {
  struct arts_remote_packet header;
  arts_guid_t edt_guid;
  unsigned int slot;
  arts_type_t mode;
...
struct __attribute__((__packed__)) arts_remote_metric_update {
  struct arts_remote_packet header;
  int type;
  uint64_t time_stamp;
  uint64_t to_add;
...
struct __attribute__((__packed__)) arts_remote_get_put_packet {
  struct arts_remote_packet header;
  arts_guid_t edt_guid;
  arts_guid_t db_guid;
...
struct __attribute__((__packed__)) arts_remote_signal_edt_with_ptr_packet {
  struct arts_remote_packet header;
  arts_guid_t edt_guid;
  arts_guid_t db_guid;
  unsigned int size;
...
struct __attribute__((__packed__)) arts_remote_send {
  struct arts_remote_packet header;
  send_handler_t fun_ptr;
};

struct __attribute__((__packed__)) arts_remote_epoch_init_packet {
  struct arts_remote_packet header;
  arts_guid_t epoch_guid;
  arts_guid_t edt_guid;
  unsigned int slot;
...
struct __attribute__((__packed__)) arts_remote_epoch_init_pool_packet {
  struct arts_remote_packet header;
...
struct __attribute__((__packed__)) arts_remote_epoch_send_packet {
  struct arts_remote_packet header;
  arts_guid_t epoch_guid;
  unsigned int active;
  unsigned int finish;
...
struct __attribute__((__packed__)) arts_remote_atomic_add_in_array_db_packet {
  struct arts_remote_packet header;
  arts_guid_t db_guid;
  arts_guid_t edt_guid;
  arts_guid_t epoch_guid;
...
arts_remote_atomic_compare_and_swap_in_array_db_packet {
  struct arts_remote_packet header;
  arts_guid_t db_guid;
  arts_guid_t edt_guid;
  arts_guid_t epoch_guid;
...
struct __attribute__((__packed__)) arts_remote_signal_context_packet {
  struct arts_remote_packet header;
  uint64_t ticket;
};

struct __attribute__((__packed__)) arts_remote_db_rename {
  struct arts_remote_packet header;
...
struct __attribute__((__packed__)) arts_remote_diff_region {
  uint32_t offset;
  uint32_t length;
};

// Partial update packet header
struct __attribute__((__packed__)) arts_remote_partial_update_packet {
  struct arts_remote_packet header;
  arts_guid_t guid;
...
struct __attribute__((__packed__)) arts_remote_time_sync_req_packet {
  struct arts_remote_packet header;
...
struct __attribute__((__packed__)) arts_remote_time_sync_resp_packet {
  struct arts_remote_packet header;

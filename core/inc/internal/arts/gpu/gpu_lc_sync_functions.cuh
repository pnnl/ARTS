...
typedef void (*artsLCSyncFunctionGpu_t)(struct arts_db *src, struct arts_db *dst);
...
__global__ void artsCopyGpuDb(struct arts_db *src, struct arts_db *dst);
__global__ void artsMinGpuDbUnsignedInt(struct arts_db *src, struct arts_db *dst);
__global__ void artsNonZeroGpuDbUnsignedInt(struct arts_db *src,
                                            struct arts_db *dst);
__global__ void artsAddGpuDbUnsignedInt(struct arts_db *src, struct arts_db *dst);

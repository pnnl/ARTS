...
typedef struct arts_array_list_element arts_array_list_element;

struct arts_array_list_element {
  uint64_t start;
  arts_array_list_element *next;
  void *array;
};
...
typedef struct {
  size_t element_size;
  size_t array_length;
  arts_array_list_element *head;
  arts_array_list_element *current;
  uint64_t index;
...
arts_array_list_element *
arts_new_array_list_element(uint64_t start, size_t element_size, size_t array_length);

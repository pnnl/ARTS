...
void arts_rehandle_ready_edt(struct arts_edt *edt);
...
void arts_thread_zero_private_init(struct thread_mask *unit,
                               struct arts_config *config);
void arts_runtime_private_init(struct thread_mask *unit, struct arts_config *config);
...
bool arts_runtime_edt_lock_db(arts_guid_t db_guid, struct arts_db *db, void *edt_packet,
                          bool shared);
void arts_runtime_edt_lock_db_signal_next(struct arts_db *db, arts_guid_t db_guid,
                                    bool remote);
struct arts_edt *arts_runtime_steal_from_worker();
struct arts_edt *arts_runtime_steal_from_network();
void arts_db_unlock(struct arts_db *db, arts_guid_t db_guid, bool write);
bool arts_db_lock_all_dbs(struct arts_edt *edt);

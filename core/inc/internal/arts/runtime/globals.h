...
struct atomic_create_barrier_info {
  volatile unsigned int wait;
  volatile unsigned int result;
};

struct arts_runtime_shared {
  ...
  struct arts_deque **receiver_deque;
  struct arts_deque **gpu_deque;
  struct arts_route_table **route_table;
  struct arts_route_table **gpu_route_table;
  struct arts_route_table *remote_route_table;
  volatile bool **local_spin;
  unsigned int **memory_moves;
  struct atomic_create_barrier_info **atomic_waits;
...
struct arts_runtime_private {
  struct arts_deque *my_deque;
  struct arts_deque *my_node_deque;
  struct arts_deque *my_gpu_deque;
  ...
  struct atomic_create_barrier_info atomic_wait;
  volatile bool alive;
...
extern struct arts_runtime_shared arts_node_info;
extern __thread struct arts_runtime_private arts_thread_info;

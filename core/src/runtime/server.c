...
void arts_server_setup(struct arts_config *config) {
...
void arts_server_process_packet(struct arts_remote_packet *packet) {
...
//        packet->seqNum);
  ...
  case ARTS_REMOTE_EDT_SIGNAL_MSG: {
    struct arts_remote_edt_signal_packet *pack =
  ...
  case ARTS_REMOTE_EVENT_SATISFY_SLOT_MSG: {
    struct arts_remote_event_satisfy_slot_packet *pack =
  ...
  case ARTS_REMOTE_PERSISTENT_EVENT_SATISFY_SLOT_MSG: {
    struct arts_remote_persistent_event_satisfy_slot_packet *pack =
  ...
  case ARTS_REMOTE_DB_ADD_DEPENDENCE_MSG: {
    struct arts_remote_db_add_dependence_packet *pack =
  ...
  case ARTS_REMOTE_DB_SEND_MSG: {
    ...
    struct arts_remote_db_send_packet *pack =
  ...
  case ARTS_REMOTE_ADD_DEPENDENCE_MSG: {
    ...
    struct arts_remote_add_dependence_packet *pack =
  ...
  case ARTS_REMOTE_ADD_DEPENDENCE_TO_PERSISTENT_EVENT_WITH_BYTE_OFFSET_MSG: {
    ...
    struct arts_remote_add_dependence_with_byte_offset_packet *pack =
  ...
  case ARTS_REMOTE_DB_FULL_SEND_MSG: {
    ...
    struct arts_remote_db_full_send_packet *pack =
  ...
  case ARTS_REMOTE_METRIC_UPDATE_MSG: {
    ...
    struct arts_remote_metric_update *pack =

...
graph_sz_t getBlockSizeForPartition(partition_t index,
                                    const arts_block_dist_t *const _dist);

partition_t getOwnerDistr(vertex_t v, const arts_block_dist_t *const _dist);
vertex_t partitionStartDistr(partition_t index,
                             const arts_block_dist_t *const _dist);
vertex_t partitionEndDistr(partition_t index,
                           const arts_block_dist_t *const _dist);
vertex_t getVertexFromLocalDistr(partition_t local, local_index_t u,
                                 const arts_block_dist_t *const _dist);
local_index_t getLocalIndexDistr(vertex_t v,
                                 const arts_block_dist_t *const _dist);

artsGuid_t getGuidForVertexDistr(vertex_t v,
                                 const arts_block_dist_t *const _dist);
artsGuid_t getGuidForPartitionDistr(const arts_block_dist_t *const _dist,
                                    partition_t index);

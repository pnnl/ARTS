...
uint64_t lowerBound(vertex_t value, uint64_t start, uint64_t end,
                    vertex_t *edges) {
...
uint64_t upperBound(vertex_t value, uint64_t start, uint64_t end,
                    vertex_t *edges) {
...
uint64_t countTriangles(vertex_t *a, uint64_t a_start, uint64_t a_end,
                        vertex_t *b, uint64_t b_start, uint64_t b_end) {
  uint64_t count = 0;
...
void visitNode(uint32_t paramc, uint64_t *paramv, uint32_t depc,
               artsEdtDep_t depv[]) {
  uint64_t localCount = 0;
